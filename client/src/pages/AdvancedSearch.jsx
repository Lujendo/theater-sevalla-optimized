      ...
      {hasSearched ? (
        ...
        <div className="bg-white rounded-lg shadow-md border border-slate-200 overflow-hidden">
          <div className="py-10 text-center">
            ...
            <h3 className="text-xl font-medium text-slate-700 mb-2">Search for Equipment</h3>
            <p className="text-slate-500 max-w-md mx-auto">
              Use the search bar or advanced filters above to find equipment in the catalog.
            </p>
          </div>
        </div>
      )}
